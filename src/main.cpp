...
/*********
  Mustafa ÖZKAYA
  Complete project details at http://www.mustafaozkaya.com.tr
*********/
...
//uint8_t mac[6] {0xA8, 0xD9, 0xB3, 0x0D, 0xAA, 0x01};
String durum = "KAPALI";
#define RELAY 4
#define LED   5
int value = LOW;
...
static const char WEB_ACTIONS1[] PROGMEM = "<a class='w3-bar-item w3-button' href='/'><i class='fas fa-home'></i> Ana Sayfa</a>"
                        "<a class='w3-bar-item w3-button' href='/configure'><i class='fas fa-cog'></i> Ayarlar</a>"
                        "<a class='w3-bar-item w3-button' href='/hswitch'><i class='fas fa-toggle-on'></i> hSwitch</a>"
                        "<a class='w3-bar-item w3-button' href='/configurenews'><i class='far fa-newspaper'></i> Haberler</a>"
                        "<a class='w3-bar-item w3-button' href='/configureoctoprint'><i class='fas fa-cube'></i> OctoPrint</a>";

static const char WEB_ACTIONS2[] PROGMEM = "<a class='w3-bar-item w3-button' href='/configurebitcoin'><i class='fab fa-bitcoin'></i> Kripto Para</a>"
                        "<a class='w3-bar-item w3-button' href='/configurepihole'><i class='fas fa-network-wired'></i> Pi-hole</a>"
                        "<a class='w3-bar-item w3-button' href='/pull'><i class='fas fa-cloud-download-alt'></i> Yenile</a>"
                        "<a class='w3-bar-item w3-button' href='/display'>";

static const char WEB_ACTION3[] PROGMEM = "</a><a class='w3-bar-item w3-button' href='/systemreset' onclick='return confirm(\"Havadurumu verilerini sıfırlamak istediğinize eminmisiniz?\")'><i class='fas fa-undo'></i> Ayarları Sıfırla</a>"
                       "<a class='w3-bar-item w3-button' href='/forgetwifi' onclick='return confirm(\"WiFi bağlantısını sıfırlamak istediğinize eminmisiniz?\")'><i class='fas fa-wifi'></i> WiFi'yi Unut</a>"
                       "<a class='w3-bar-item w3-button' href='/restart'><i class='fas fa-sync'></i> Yeniden Başlat</a>"
                       "<a class='w3-bar-item w3-button' href='/update'><i class='fas fa-wrench'></i> Firmware Güncelle</a>"
                       "<a class='w3-bar-item w3-button' href='https://github.com/hololu' target='_blank'><i class='fas fa-question-circle'></i> Hakkında</a>";
...
static const char CHANGE_FORM1[] PROGMEM = "<form class='w3-container' action='/locations' method='get'><h2>Ayarlar:</h2>"
                      "<label>TimeZone DB API Key (<a href='https://timezonedb.com/register' target='_BLANK'>burdan</a> alabilirsiniz)</label>"
                      "<input class='w3-input w3-border w3-margin-bottom' type='text' name='TimeZoneDB' value='%TIMEDBKEY%' maxlength='60'>"
                      "<label>OpenWeatherMap API Key (<a href='https://openweathermap.org/' target='_BLANK'>burdan</a> Alabilirsiniz)</label>"
                      "<input class='w3-input w3-border w3-margin-bottom' type='text' name='openWeatherMapApiKey' value='%WEATHERKEY%' maxlength='70'>"
                      "<p><label>%CITYNAME1% (<a href='http://openweathermap.org/find' target='_BLANK'><i class='fas fa-search'></i> Şehir ID si Ara</a>)</label>"
                      ...
                      "<p><input name='showcity' class='w3-check w3-margin-top' type='checkbox' %CITY_CHECKED%> Şeir Adını Göster</p>"
                      ...
                      "<p><input name='showwind' class='w3-check w3-margin-top' type='checkbox' %WIND_CHECKED%> Rüzgarı Göster</p>"
...
static const char BITCOIN_FORM[] PROGMEM = "<form class='w3-container' action='/savebitcoin' method='get'><h2>Kripto Para Ayarları:</h2>"
                        "<div class='w3-cell-row'><script src='https://widgets.coingecko.com/coingecko-coin-heatmap-widget.js'></script><coingecko-coin-heatmap-widget  height='400' locale='tr'></coingecko-coin-heatmap-widget></div><br><hr>"
                        "<div class='w3-cell-row'><script src='https://widgets.coingecko.com/coingecko-coin-list-widget.js'></script><coingecko-coin-list-widget  coin-ids='bitcoin,ethereum,ripple,ravencoin,zcoin,binancecoin,chiliz' currency='usd' locale='tr'></coingecko-coin-list-widget></div><br><hr>"
...
static const char CURRENCY_OPTIONS[] PROGMEM = "<option value='NONE'>NONE</option>"
                          "<option value='TRY'>Türk Lirasi</option>"
...
void sendHeader() {
  ...
  html += "<html lang='tr'><head><title>hOLOlu Switch</title><link rel='icon' href='data:;base64,='>";
  ...
  html = "</nav>";
  html += "<header class='w3-top w3-bar w3-theme'><button class='w3-bar-item w3-button w3-xxxlarge w3-hover-theme' onclick='openSidebar()'><i class='fas fa-bars'></i></button><h2 class='w3-bar-item'>hOLOlu Switch</h2></header>";
  html += "<script>";
...
void sendFooter() {
  ...
  html += "<i class='far fa-clock'></i> Sonraki Güncelleme: " + getTimeTillUpdate() + "<br>";
...
void displayWeatherData() {
  ...
  // GPIO 2  Durumunue görelim..!
  html +="<p>Durum " + durum + "</p>";
  /*
  if (value == LOW) {
    html +="<p><a href=\"/RELAY=ON\"><button class=\"button\">AÇ</button></a></p>";
  } else {
    html +="<p><a href=\"/RELAY=OFF\"><button class=\"button button2\">KAPAT</button></a></p>";
  } 
  */
  ...
  if (TIMEDBKEY == "") {
    html += "<p><a href='/configure'>TimeZoneDB Ayarları</a> Lütfen API key tanımlayınız</p>";
  }

  if (weatherClient.getCity(0) == "") {
    html += "<p><a href='/configure'>Havadurumu Ayarları</a> Lütfen API key tanımlayınız</p>";
    ...
    html += time + "<br>";
    html += "<a href='https://www.google.com/maps/@" + String(weatherClient.getLat(0)) + "," + String(weatherClient.getLon(0)) + ",10000m/data=!3m1!1e3' target='_BLANK'><i class='fas fa-map-marker' style='color:red'></i> Map It!</a><br>";
    html += "</p></div></div><hr>";
  }
...
void getWeatherData() //client function to send/receive GET request data.
{
  ...
  Serial.println();
    ...
    if (weatherClient.getError() != "") {
      Serial.println(weatherClient.getError());
    }
  Serial.println("Updating Time...");
  TimeDB.updateConfig(TIMEDBKEY, String(weatherClient.getLat(0)), String(weatherClient.getLon(0)));
...
void hSwitch()
{
  ...
  if (value == LOW) {
    //String form = FPSTR("<div class='w3-cell-row'><h2>Durum "+ durum +"</h2><p><a href=\"/RELAY=ON\"><button class=\"button\">AÇ</button></a></p></div><br><hr>");
    html = "<div class='w3-cell-row'><h2>Durum "+ durum +"</h2><p><a href=\"/RELAY=ON\"><button class=\"button\">AÇ</button></a></p>"
    "<p><a href=\"/RELAY=RESET\"><button class=\"button button2\">RESET</button></a></p>"
    "</div><br><hr>";
    //static char mtn[] PROGMEM = "<div class='w3-cell-row'><h2>Durum \"+durum+\"</h2><p><a href=\"/RELAY=ON\"><button class=\"button\">AÇ</button></a></p></div><br><hr>";
  } else {
    //String form = FPSTR("<div class='w3-cell-row'><h2>Durum "+ durum+"</h2><p><a href=\"/RELAY=OFF\"><button class=\"button button2\">KAPAT</button></a></p></div><br><hr>");
    html = "<div class='w3-cell-row'><h2>Durum "+ durum+"</h2><p><a href=\"/RELAY=OFF\"><button class=\"button button2\">KAPAT</button></a></p>"
    "<p><a href=\"/RELAY=RESET\"><button class=\"button button2\">RESET</button></a></p>"
    "</div><br><hr>";
    //static char mtn[] PROGMEM = "<div class='w3-cell-row'><h2>Durum \"+durum+\"</h2><p><a href=\"/RELAY=OFF\"><button class=\"button button2\">KAPAT</button></a></p></div><br><hr>";
  } 

  //String form = FPSTR(mtn);
  server.sendContent(html);
...
void setup() {
  ...
  if (WEBSERVER_ENABLED) {
    ...
    server.on("/RELAY=ON", handelRelayOn);
    server.on("/RELAY=OFF", handelRelayOff);
    server.on("/RELAY=RESET", handelRelayReset);
    server.on("/hswitch", hSwitch);
...
void loop() {
/*
  Serial.print("getMinutesFromLastRefresh : ");
  Serial.println(getMinutesFromLastRefresh());
  Serial.println("---------------------------");
  Serial.print("minutesBetweenDataRefresh : ");
