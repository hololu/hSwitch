...
String TIMEDBKEY = "VTO3XIH40IJL"; // Your API Key from https://timezonedb.com/register
String APIKEY = "ffa7fbbd22a8cc4157929f73e1e77d6a"; // Your API Key from http://openweathermap.org/
// Default City Location (use http://openweathermap.org/find to find city ID)
int CityIDs[] = { 738647 }; //Only USE ONE for weather marquee
...
String NEWS_API_KEY = "b1532beae915493b8e4889b4ae129a5c"; // Get your News API Key from https://newsapi.org
...
String BitcoinCurrencyCode = "TRY";  // Change to USD, GBD, EUR, or NONE -- this can be managed in the Web Interface
...
String PiHoleServer = "10.10.22.14";     // IP or Address only (DO NOT include http://)
